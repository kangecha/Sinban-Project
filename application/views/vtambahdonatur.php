<div class="row">
	...
	<div class="notice marker-on-right bg-white fg-black" style="height:500px">
		...
		<div class="row">
			<form action="<?php echo site_url();?>administrator/tambahDonatur" method="POST">
                <fieldset>
            	     <legend>TAMBAH DATA DONATUR</legend>
            	     <input type="hidden" name="tanggal_update" value="<?php echo date('Y-m-d'); ?>">
                     <label>NAMA DONATUR</label>
                     <div class="input-control text" data-role="input-control">
                 	    <input type="text" placeholder="Masukan Nama Lengkap Donatur" name="nama_donatur">
                    	 <button class="btn-clear" tabindex="-1"></button>
                     </div>

                     <label>ALAMAT DONATUR</label>
                     <div class="input-control text" data-role="input-control">
                 	    <input type="text" placeholder="Masukan Alamat Donatur" name="alamat_donatur">
                    	 <button class="btn-clear" tabindex="-1"></button>
                     </div>

                     
                                        
       	             <?php echo form_submit('submit','Simpan Donatur') ?>
                 </fieldset>
            </form>
		</div>

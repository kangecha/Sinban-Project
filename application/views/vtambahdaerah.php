<div class="row">
	...
	<div class="notice marker-on-right bg-white fg-black" style="height:500px">
		...
		<div class="row">
			<form action="<?php echo site_url();?>administrator/tambahDaerah" method="POST">
                <fieldset>
            	     <legend>TAMBAH DATA DAERAH</legend>
                     <label>NAMA DAERAH</label>
                     <div class="input-control text" data-role="input-control">
                 	    <input type="text" placeholder="Masukan Nama Daerah" name="namadaerah">
                    	 <button class="btn-clear" tabindex="-1"></button>
                     </div>

                     <label>LATITUDE</label>
                     <div class="input-control text" data-role="input-control">
                 	    <input type="text" placeholder="Masukan Latitude" name="latitude">
                    	 <button class="btn-clear" tabindex="-1"></button>
                     </div>

                     <label>LONGITUDE</label>
                     <div class="input-control text" data-role="input-control">
                 	    <input type="text" placeholder="Masukan Latitude" name="longitude">
                    	 <button class="btn-clear" tabindex="-1"></button>
                     </div>
